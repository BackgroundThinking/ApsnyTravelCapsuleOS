...
export default function Home() {
  ...
  const featuredPlaces = capsules
    .filter(c => c.tier === 2 && c.type === "place")
    .slice(0, 4);
    ...
    <div className="min-h-screen flex flex-col bg-background font-sans">
        ...
        <div className="relative container h-full flex flex-col justify-center z-10 text-white">
          <div className="max-w-4xl space-y-6">
            ...
            <p className="text-xl md:text-2xl max-w-2xl font-light text-white/90">
              Discover the silent majesty of the Caucasus. From frozen alpine
              lakes to steaming thermal springs.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Abkhazia in winter is a land of striking contrasts. In the
                morning, you can be freeriding on the virgin slopes of the
                Caucasus Mountains, and by evening, relaxing in hot thermal
                springs surrounded by eucalyptus groves.
              </p>
              <div className="grid grid-cols-2 gap-8 pt-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Natural healing waters open year-round.
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pristine slopes and backcountry routes.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative aspect-[4/5] bg-muted">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white p-8 shadow-xl max-w-xs hidden md:block">
                ...
                <p className="text-sm mt-2">
                  Founded in 1875, a spiritual center amidst the mountains.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {loading
              ? [1, 2, 3].map(i => (
                  <div
                    key={i}
                    className="aspect-[3/4] bg-muted animate-pulse"
                  />
                ))
      ...
      <section className="py-24 bg-background">
        <div className="container">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground">
              Explore the diverse landscapes of the region. From the Black Sea
              coast to the high peaks of the Caucasus.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border border border-border">
            {loading
              ? [1, 2, 3, 4].map(i => (
                  <div
                    key={i}
                    className="aspect-square bg-background animate-pulse"
                  />
                ))
      ...
      <section className="py-32 bg-sidebar text-sidebar-foreground relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img
            src="/images/hero-gagra-colonnade.jpg"
        ...
        <div className="container relative z-10 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-xl mx-auto mb-12">
            Book your winter tour now and experience the magic of Abkhazia with
            expert guides.
          </p>
